    ...
    <section id="cv" className="w-full min-h-screen px-6 py-16 text-white">
      ...
      <div className="flex flex-row gap-6 sm:gap-10 md:gap-14 w-full">
        ...
        <div className="w-1/3 space-y-8 sticky top-24">
          ...
          {/* Botón descarga */}
          <div>
            <button className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-2 border border-white bg-white/10 rounded-md hover:bg-white/20 transition w-fit max-w-[90%]">
        ...
        <div className="w-2/3 space-y-12">
          {/* Aquí irán los bloques de contenido: Sobre mí, estudios y experiencia */}
