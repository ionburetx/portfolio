...
const socialLinks = [
  {
    name: 'Instagram',
    href: 'https://instagram.com/ionburetx',
    iconPath: (
  ...
  {
    name: 'GitHub',
    href: 'https://github.com/ionburetx',
    iconPath: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/ion-burgoa-204156324',
    iconPath: (
...
const navigate = useNavigate();
  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col pt-24 pr-6 font-semibold text-lg">
        {/* Categorías */}
        ...
        {/* Línea divisoria */}
        <hr className="border-t border-white border-opacity-30 my-10" />
