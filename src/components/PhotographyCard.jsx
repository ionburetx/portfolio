...
const PhotographyCard = ({ image, title }) => {
  return (
    <div className="photography-card relative w-full aspect-square cursor-pointer overflow-hidden group">
      ...
      />
      <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center transition-opacity duration-300 ease-in-out group-hover:opacity-0">
